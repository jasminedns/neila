...
export default function Home() { 
  return (
    <>
      ...
      <div className="absolute bottom-0 md:top-[74%] lg:top-[74%] w-full min-h-[248px] flex justify-center bg-cover bg-[url('/border.png')] bg-[position:100%_5%] z-10 top-74vh">
  ...
  target="_blank" 
  className="hover:underline font-montserrat text-base md:text-[20px] lg:text-[20px]"
>
