...
export default function Home() { 
  ...
  <div className="p-3 border-2 flex flex-row items-center sm:top[10px] justify-center bg-[#b88a00] shadow-xl team_button gap-3 border-[#FFD700] rounded-sm relative z-30">
    <SiItchdotio size={32} fill="white" />
    <a
      href="https://futuregames.itch.io/project-neila"
      target="_blank"
      className="hover:underline font-montserrat text-base md:text-[20px] lg:text-[20px] text-white"
    >
