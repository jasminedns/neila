...
const ProjectInfoPage = () => {
    return (
        <div className="min-h-screen bg-gray-800 p-6  text-white text-xl">
            ...
            <h4 className="font-cinzel m-3 text-2xl font-bold">The Project:</h4>
            ...
            <li className="m-6 mt-8 font-montserrat text-2xl">Project Neila is in early development.We welcome all feedback-especially
            ...
            <div className="m-6 mt-10"> 
                <h6 className="font-bold mt-4 text-justify font-montserrat">Player Freedom</h6>
            ...
            <div className="m-6 mt-10">
                <h6 className="mt-4 font-bold font-montserrat">Emergent Gameplay</h6>
            ...
            <div className="m-6 mt-10">
                <h6 className="font-bold font-montserrat">Immersion</h6>
