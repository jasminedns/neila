...
const StoryElement = () => {
    return (
        <>
        <div>
            <h3 className="font-cinzel z-10 text-gold text-4xl font-bold text-right mr-50 mb-5 mt-20">
                The Story :
            </h3>
            <div className="flex justify-end w-full min-h-[150px]">
            <div className="flex flex-col items-center justify-center mr-30 mb-20 w-full max-w-[1400px] bg-[#FFD700]/3 border border-[#FFD700]/20 rounded-[10px] p-4 min-h-[250px]">
