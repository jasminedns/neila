...
const StoryElement = () => {
    return (
        ...
        <div>
            ...
            <div className=" flex justify-end min-h-[150px]">
            <div className="relative flex flex-col items-center justify-center mr-30 mb-20 sm:mb-40 ml-20 w-full max-w-[85%] bg-[#FFD700]/3 border border-[#FFD700]/20 rounded-[10px] p-4 min-h-[260px] md:max-w-[1000px]">
